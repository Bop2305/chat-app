...
const CreateChatModal: React.FC<CreateChatModalProps> = ({ isOpen, onClose }) => {
  ...
  return <Modal title="Create Chat" isOpen={isOpen} onClose={onClose}>
    <div>
      <div className="flex gap-2">
        <FormInput name="participant" placeholder="Input Participant Email" register={formResult.register} />
        <Button label="Add" onClick={formResult.handleSubmit(handleAddParticipant)} />
      </div>
